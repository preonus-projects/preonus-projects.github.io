...
# How to Use Preonus Framework Tool

## 1. Open the Dashboard
Click the **Preonus icon** in the VS Code Activity Bar.
...
## 3. Manage Your Project Lifecycle
- Select your project
